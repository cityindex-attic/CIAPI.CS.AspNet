var CIAPI=CIAPI||{};(function(b,c){function a(d,e){if(d===c){CIAPI.log(e+"must be referenced")}}a(b,"jQuery 1.5.1+");a(b.widget,"jQuery UI 1.8+");b.widget("ui.CIAPI_widget",{version:"@VERSION",options:{dependencies:[{obj:b,description:"jQuery 1.5.1+"},{obj:b.widget,description:"jQuery UI 1.8+"}]},_checkDependencies:function(){for(var d in dependencies){a(dependencies[d].obj,dependencies[d].description)}}})}(jQuery));// Knockout JavaScript library v1.2.0
