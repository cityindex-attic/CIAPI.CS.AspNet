...
(function(a,b,c){a.request.decoders.ciapiDecoder=function(f,d,h,g,e){if(!f.ErrorCode){g(f)}else{e(f)}};a.request.define("createSession","cors",{url:"{ServiceUri}/session?only200=true",dataType:"json",contentType:"application/json; charset=utf-8",type:"POST",processData:false,beforeSend:function(e,d){d.data=JSON.stringify(d.data);return true},decoder:"ciapiDecoder"});a.request.define("DeleteSession","cors",{url:"{ServiceUri}/deleteSession?userName={UserName}&session={Session}&only200=true",dataType:"json",contentType:"application/json; charset=utf-8",type:"POST",decoder:"ciapiDecoder"});a.request.define("ListCfdMarkets","cors",{url:"{ServiceUri}/cfd/markets?MarketName={searchByMarketName}&MarketCode={searchByMarketCode}&ClientAccountId={clientAccountId}&MaxResults={maxResults}&only200=true",dataType:"json",contentType:"application/json; charset=utf-8",type:"GET",decoder:"ciapiDecoder"});a.request.define("GetPriceBars","cors",{url:"{ServiceUri}/market/{marketId}/barhistory?interval={interval}&span={span}&priceBars={maxResults}&only200=true",dataType:"json",contentType:"application/json; charset=utf-8",type:"GET",decoder:"ciapiDecoder"})})(amplify,_);
var CIAPI=CIAPI||{};(function(a,b,c){CIAPI.connection=CIAPI.store("CIAPI.connection")||{};b(CIAPI.connection).defaults({isConnected:false,UserName:"",Session:"",ServiceUri:"",StreamUri:""});CIAPI.connect=function(d){b(d).defaults({UserName:CIAPI.connection.UserName,Password:c,ServiceUri:CIAPI.connection.ServiceUri,StreamUri:CIAPI.connection.StreamUri,success:function(){},error:function(){}});a.request({resourceId:"createSession",data:{ServiceUri:d.ServiceUri,UserName:d.UserName,Password:d.Password},success:function(e){CIAPI.connection.isConnected=true;CIAPI.connection.UserName=d.UserName;CIAPI.connection.Session=e.Session;CIAPI.store("CIAPI.connection",CIAPI.connection);CIAPI.storeInCookie("UserName",CIAPI.connection.UserName);CIAPI.storeInCookie("Session",CIAPI.connection.Session);d.success(e)},error:function(e){CIAPI.connection.isConnected=false;CIAPI.connection.Session="";CIAPI.store("CIAPI.connection",CIAPI.connection);CIAPI.storeInCookie("UserName","");CIAPI.storeInCookie("Session","");d.error(e)}})};CIAPI.disconnect=function(d){d=d||{};b(d).defaults({success:function(){},error:function(){}});a.request({resourceId:"DeleteSession",data:{ServiceUri:d.ServiceUri,UserName:d.UserName,Session:d.Session},success:function(e){CIAPI.connection.isConnected=false;CIAPI.connection.UserName="";CIAPI.connection.Session="";CIAPI.store("CIAPI.connection",CIAPI.connection);CIAPI.storeInCookie("UserName","");CIAPI.storeInCookie("Session","");d.success(e)},error:function(e){d.error(e)}})}})(amplify,_);
